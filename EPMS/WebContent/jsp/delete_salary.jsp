     ...
     <div class="col-lg-9" id="tag">
       <div class="delete-salary-info">
		...
		<div id="main" class="col-lg-12">
			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/SalaryMana?method=getOneInfo" method="post">
				...
				<table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="delete" href="${pageContext.request.contextPath }/SalaryMana?method=deleteSalary&pid=${i.personalSalary.pid}&year=${i.personalSalary.year }&month=${i.personalSalary.month}">删除</a></td>
                        </tr>
                        </c:forEach>
                    </tbody>
                </table>
