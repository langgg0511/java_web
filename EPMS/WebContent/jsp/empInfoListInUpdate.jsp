                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        	<c:forEach items="${requestScope.list }" var="i">
                        		...
                        		<td><a href="${pageContext.request.contextPath }/empInfoMana?method=toEmployeeInfoInUpdate&id=${i.employeeInfo.eid }&name=${i.employeeInfo.name }&age=${i.employeeInfo.age }&sex=${i.employeeInfo.sex }&department=${i.department.id }&job=${i.job.id }&time=${i.employeeInfo.time }"  >修改</a></td>
                        		</tr>
                       		 </c:forEach>
                    </tbody>
                </table>
