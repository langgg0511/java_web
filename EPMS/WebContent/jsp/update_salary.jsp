...
<div class="container">
    <div class="col-lg-9" id="tag">
        ...
        <div id="main" class="col-lg-12">
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/SalaryMana?method=getOneInfoByUpdate" method="post">
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="update" href="${pageContext.request.contextPath }/SalaryMana?method=toUpdateSalary&pid=${i.personalSalary.pid}&year=${i.personalSalary.year }&month=${i.personalSalary.month}">修改</a></td>
                        </tr>
                        </c:forEach>
                    </tbody>
