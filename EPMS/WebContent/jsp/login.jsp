...
<link href="${pageContext.request.contextPath }/css/企业人事登录页面.css" rel="stylesheet" />
<style>
#content {
	width: 1000px;
	height: 550px;
	background-image: url(${pageContext.request.contextPath }/img/首页背景图2.jpg);
...
<!--顶部 页面logo-->
	<div id="header">
		<div id="inside">
			<img src="${pageContext.request.contextPath }/img/企业人事管理系统头部.png" alt="企业人事管理系统"/>
		</div>
	</div>
	<div id="bg">
	<div id="content" >
		
		<form name="login-form"  method="post" action="${pageContext.request.contextPath }/LoginServlet" id="login-form" style="display: block; height: 240px; overflow: hidden;">
		<div id="login-frame">
