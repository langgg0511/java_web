...
<%
	...
	application.setAttribute("number",(String)application.getAttribute("number") );
%>
...
<div class="container">
   <div class="col-lg-12 head">
        ...
        <div class="exit-user">
            <span><%=application.getAttribute("number") %></span>
            <a href="#">退出</a>
        </div>
    </div>
