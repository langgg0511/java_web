<%@page import="epms.b_empInfoMana.entity.Job"%>
<%@page import="epms.b_empInfoMana.entity.Department"%>
...
<body>
	<%
		...
		List<Department> deptList = (List<Department>) serviceImpl
				.queryDeptInfo();
	...
	<div class="col-lg-8" id="main">
		<form action="/epms/EmpUpdateServlet" method="post"
